# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-11 02:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Facility', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Facility')),
                ('InsuranceCompany', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.InsuranceCompany')),
                ('Patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Patient')),
            ],
        ),
        migrations.CreateModel(
            name='PatientMedicalHistorySymptomDiagnosis',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Diagnosis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Diagnosis')),
                ('PatientMedicalHistory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.PatientMedicalHistory')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='patientmedicalhistorysymptomdiagnosis',
            name='Symptom',
